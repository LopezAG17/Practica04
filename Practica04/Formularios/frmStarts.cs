...
//arquitectura de componentes heredada de Win32 que se usa en todas las aplicaciones de Windows y Windows.
...
namespace Practica04
{
  public partial class frmStarts : Form
  {
    ...
    private void txtuser_Enter(object sender, EventArgs e)
    {
      if (txtuser.Text == "Usuario")
      {
        ...
        txtuser.ForeColor = Color.Blue;   // cuando el foco esta en el textbox este cuando escriba, escribira de color azul
                                          //txtuser.BackColor = Color.BlueViolet;
      }
    }
    ...
    private void txtuser_KeyPress(object sender, KeyPressEventArgs e)
    {
      ...
      {  // aqui pregunta si la tecla pulsada es Enter
        e.Handled = true;
    ...
    void AbrirCerrarForm()
    {
      ...
      Menu.ShowDialog();  // muestra el formulario Menu
                          //this.Close();
    }
  }
}
